    ...
    <div class="col-lg-11">
        <form method="post" action="/dashboard/user">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="bengkel_name" class="form-label">Nama Instansi/Bengkel<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('bengkel_name') is-invalid @enderror"
                            id="bengkel_name" name="bengkel_name" required value="{{ old('bengkel_name') }}">
                        @error('bengkel_name')
                    ...
                    <div class="mb-3">
                        <label for="perusahaan_name" class="form-label">Nama Cabang</label>
                        <input type="text" class="form-control @error('perusahaan_name') is-invalid @enderror"
                            id="perusahaan_name" name="perusahaan_name" value="{{ old('perusahaan_name') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kepala_bengkel') is-invalid @enderror"
                            id="kepala_bengkel" name="kepala_bengkel" required value="{{ old('kepala_bengkel') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('user_kategori') is-invalid @enderror"
                            id="user_kategori" name="user_kategori" required value="{{ old('user_kategori') }}">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kab_kota') is-invalid @enderror" id="kab_kota"
                            name="kab_kota" value="{{ old('kab_kota') }}">
                        @error('kab_kota')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('alat_uji') is-invalid @enderror"
                                    id="alat_uji" name="alat_uji" value="{{ old('alat_uji') }}">
                                @error('alat_uji')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('tanggal_kalibrasi_alat') }}">
